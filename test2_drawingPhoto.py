...
IN THIS VERSION WE WILL ADD THE FUNCTIONALITY TO ACTUALLY OPEN AND DISPLAY
THE IMAGE THE USER WANTS TO USE.  IT WILL DISPLAY THE IMAGE IN A RECTANGLE WITH A
SET HIGHT AND AN AUTOMATIC WIDTH... OR MAYBE AN AUTO HIGHT AND SET WIDTH.

THE IMAGE WILL BE PLACED UNDER THE "TEXTBOX"
"""
